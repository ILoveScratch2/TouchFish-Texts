...
const { getRendererEnvironmentDefinitions } = require('./touchfishTextsEnvironment')
...
if (process.env.NODE_ENV !== 'production' && process.env.NODE_ENV !== 'test' &&
  !process.env.TOUCHFISH_TEXTS_DEV_HIDE_BROWSER_ANALYZER) {
  rendererConfig.plugins.push(
...
if (!isProduction && process.env.TOUCHFISH_TEXTS_BUILD_VSCODE_DEBUG) {
