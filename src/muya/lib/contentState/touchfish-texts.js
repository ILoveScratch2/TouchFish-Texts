// __TOUCHFISH_TEXTS_ONLY__

import { extractWord, offsetToWordCursor, validateLineCursor } from '../touchfish-texts/spellchecker'
import selection from '../selection'

const touchFishTextsApi = ContentState => {
  /**
   ...
   * is currently used to replace a misspelled word in TouchFish Texts that was selected
   * by Chromium.
   *
...
export default touchFishTextsApi
