...
const setupEnvironment = args => {
  ...
  const debug = args['--debug'] || !!process.env.TOUCHFISH_TEXTS_DEBUG || process.env.NODE_ENV !== 'production'
  ...
  global.TOUCHFISH_TEXTS_DEBUG = debug
  global.TOUCHFISH_TEXTS_DEBUG_VERBOSE = verbose
  global.TOUCHFISH_TEXTS_SAFE_MODE = safeMode
