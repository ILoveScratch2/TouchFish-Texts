<template>
  <div class="pref-editor">
    <h4>{{ $t('prefEditor.title') }}</h4>
    <compound>
      <template #head>
        <h6 class="title">{{ $t('prefEditor.textEditorTitle') }}</h6>
      </template>
      <template #children>
        <range
          :description="$t('prefEditor.fontSize')"
          :value="fontSize"
          :min="12"
          :max="32"
          unit="px"
        ...
        ></range>
        <range
          :description="$t('prefEditor.lineHeight')"
          :max="2.0"
          :step="0.1"
          :onChange="value => onSelectChange('lineHeight', value)"
        ></range>
        <font-text-box
          :description="$t('prefEditor.fontFamily')"
          :onChange="value => onSelectChange('editorFontFamily', value)"
        ></font-text-box>
        <text-box
          :description="$t('prefEditor.editorLineWidth')"
          :notes="$t('prefEditor.editorLineWidthNotes')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('prefEditor.codeBlockTitle') }}</h6>
      </template>
      <template #children>
        <range
          :description="$t('prefEditor.fontSize')"
        ...
        ></bool>
        <bool
          :description="$t('prefEditor.trimCodeBlockEmptyLines')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('prefEditor.writingBehaviorTitle') }}</h6>
      </template>
      <template #children>
        <bool
          :description="$t('prefEditor.autoPairBracket')"
          :bool="autoPairBracket"
          :onChange="value => onSelectChange('autoPairBracket', value)"
        ></bool>
        <bool
          :description="$t('prefEditor.autoPairMarkdownSyntax')"
          :bool="autoPairMarkdownSyntax"
          :onChange="value => onSelectChange('autoPairMarkdownSyntax', value)"
        ></bool>
        <bool
          :description="$t('prefEditor.autoPairQuote')"
          :bool="autoPairQuote"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('prefEditor.miscTitle') }}</h6>
      </template>
      <template #children>
        <cur-select
          :description="$t('prefEditor.textDirection')"
          :value="textDirection"
          :options="textDirectionOptions"
          :onChange="value => onSelectChange('textDirection', value)"
        ></cur-select>
        <bool
          :description="$t('prefEditor.hideQuickInsertHint')"
          :bool="hideQuickInsertHint"
          :onChange="value => onSelectChange('hideQuickInsertHint', value)"
        ></bool>
        <bool
          :description="$t('prefEditor.hideLinkPopup')"
          :bool="hideLinkPopup"
          :onChange="value => onSelectChange('hideLinkPopup', value)"
        ></bool>
        <bool
          :description="$t('prefEditor.autoCheck')"
          :bool="autoCheck"
