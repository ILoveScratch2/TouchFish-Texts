  ...
  <div class="print-settings-dialog">
    ...
    >
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane :label="$t('exportSettings.tabInfo')" name="info">
          <span class="text">{{ $t('exportSettings.infoText') }}</span>
        </el-tab-pane>
        <el-tab-pane :label="$t('exportSettings.tabPage')" name="page">
          <!-- HTML -->
          <div v-if="!isPrintable">
            <text-box
              :description="$t('exportSettings.pageTitle')"
              :input="htmlTitle"
              :emitTime="0"
          ...
          <div v-if="isPrintable">
            <div v-if="exportType === 'pdf'">
              ...
              <bool
                :description="$t('exportSettings.landscapeOrientation')"
                :bool="isLandscape"
            ...
            <div class="row">
              <div class="description">{{ $t('exportSettings.pageMarginMm') }}</div>
              <div>
                <div class="label">{{ $t('exportSettings.topBottom') }}</div>
              ...
              <div>
                <div class="label">{{ $t('exportSettings.leftRight') }}</div>
        ...
        <el-tab-pane :label="$t('exportSettings.tabStyle')" name="style">
          <bool
            :description="$t('exportSettings.overwriteFont')"
            :bool="fontSettingsOverwrite"
            :onChange="value => onSelectChange('fontSettingsOverwrite', value)"
          ></bool>
          <div v-if="fontSettingsOverwrite">
            <font-text-box
              :description="$t('exportSettings.fontFamily')"
              :value="fontFamily"
              :onChange="value => onSelectChange('fontFamily', value)"
            ></font-text-box>
            <range
              :description="$t('exportSettings.fontSize')"
              :value="fontSize"
              :min="8"
              :max="32"
              unit="px"
            ...
            ></range>
            <range
              :description="$t('exportSettings.lineHeight')"
              :value="lineHeight"
              :min="1.0"
              :max="2.0"
              :step="0.1"
          ...
          <bool
            :description="$t('exportSettings.autoNumberHeadings')"
        ...
        <el-tab-pane :label="$t('exportSettings.tabTheme')" name="theme">
          <div class="text">{{ $t('exportSettings.themeText') }}</div>
          <cur-select
            :description="$t('exportSettings.theme')"
            more="https://touchfishtexts.ilovescratch.us.ci/export-themes"
            :value="theme"
            :options="themeList"
            :onChange="value => onSelectChange('theme', value)"
          ></cur-select>
        </el-tab-pane>
        <el-tab-pane v-if="isPrintable" :label="$t('exportSettings.tabHeaderFooter')" name="header">
          <div class="text">{{ $t('exportSettings.headerFooterText') }}</div>
          <cur-select
            :description="$t('exportSettings.headerType')"
            :value="headerType"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('exportSettings.leftHeaderText')"
          ...
          <text-box
            v-if="headerType !== 0"
            :description="$t('exportSettings.mainHeaderText')"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('exportSettings.rightHeaderText')"
          ...
          <cur-select
            :description="$t('exportSettings.footerType')"
            :value="footerType"
            :options="headerFooterTypes"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('exportSettings.leftFooterText')"
          ...
          <text-box
            v-if="footerType !== 0"
            :description="$t('exportSettings.mainFooterText')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('exportSettings.rightFooterText')"
          ...
          <bool
            :description="$t('exportSettings.customizeStyle')"
          ...
          <div v-if="headerFooterCustomize">
            <bool
              :description="$t('exportSettings.allowStyledHeaderFooter')"
              :bool="headerFooterStyled"
              :onChange="value => onSelectChange('headerFooterStyled', value)"
            ></bool>
            <range
              :description="$t('exportSettings.headerFooterFontSize')"
        ...
        <el-tab-pane :label="$t('exportSettings.tabToc')" name="toc">
          <bool
            :description="$t('exportSettings.includeTopHeading')"
            :detailedDescription="$t('exportSettings.includeTopHeadingDetail')"
            :bool="tocIncludeTopHeading"
            :onChange="value => onSelectChange('tocIncludeTopHeading', value)"
          ></bool>
          <text-box
            :description="$t('exportSettings.tocTitle')"
            :input="tocTitle"
            :emitTime="0"
...
export default {
  ...
  methods: {
    ...
    loadThemesFromDisk () {
      const { userDataPath } = global.touchFishTexts.paths
