...
export default {
  ...
  methods: {
    ...
    reportViaGithub () {
      shell.openExternal('https://github.com/touchfish-texts/touchfish-texts/issues/new')
    },
    reportViaTwitter () {
      ...
      const params = {
        via: 'touchfish-textsme',
        url: encodeURI('https://github.com/touchfish-texts/touchfish-texts/'),
        text: value
      }

      if (selectedFace === 'smile') params.hashtags = 'happyTouchFish Texts'
